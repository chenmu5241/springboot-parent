...
<div class="row">
	<div class="col-xs-12">
		...
		<div clas="col-xs-12">
		<a class="btn  btn-success btn-app" type="button" href="#role/toAdd">
		...
		<table id="table">
			<thead>
				<tr>
							...
							<th data-field="name"  data-align="center"  data-sortable="true">角色名称</th>
							<th data-field="description"  data-align="center"  data-sortable="true">角色描述</th>
...
<script>
	function operateFormatter(value, row, index) {
		...
		if(value==1){//超级管理员不给删除
			...
			html +='<a class="blue tooltip-info" href="#role/toPowerManage?id='+value+'"   title="配置权限"><i class="ace-icon fa fa-cog bigger-130"></i></a>' 
			html += '<a class="green tooltip-info" name="update_op" href="#role/toEdit?id='+value+'" data-rel="tooltip" data-placement="bottom" title="编辑"><i class="ace-icon fa fa-pencil bigger-130"></i></a>'
			html +=  '<a class="red" href="javascript:void(0)" onclick="bt1.remove(\'${ctx}/role/delete\','+ value + ')" title="删除"><i class="ace-icon fa fa-trash-o bigger-130"></i>' + '</a>' ;
		}
		return [ html ];
	}
	...
	var bt1 = bootStrapTable.initTable("#table", '${ctx}/role/getList',{
		sortName:"id",
		sortOrder:"asc",
