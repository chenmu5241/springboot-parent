...
<body class="login-layout light-login ">
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="login-container pull-right">
						<div class="center">
							<h1>
								<span class="green" id="id-text2">智能康复训练管理系统</span>
							</h1>
						</div>
											...
											<form class="form-inline" method="post" action="${ctx}/loginSubmit"  data-validator-option="{timely:2, theme:'yellow_top'}">
												...
												<fieldset>
													<label class="block clearfix"> <span class="block input-icon input-icon-right"> <input type="text" class="form-control" placeholder="用户名" name="username" id="username"
															value="" data-rule="用户名:required;" style="width: 100%" /><i class="ace-icon fa fa-user"></i>
													</span>
													</label> <label class="block clearfix"> <span class="block input-icon input-icon-right"> <input type="password" class="form-control" id="password" data-rule="密码:required;" value=""
															name="password" maxlength="25" style="width: 100%" placeholder="密码" /><i class="ace-icon fa fa-lock"></i>
													</span>
	...
	<script type="text/javascript">
		if ('ontouchstart' in document.documentElement)
			document.write("<script src='${basePath}static/assets/js/jquery.mobile.custom.js'>" + "<"+"/script>");
	</script>
